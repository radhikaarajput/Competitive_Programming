lass Solution{
    ...
    int findPlatform(int arr[], int dep[], int n)
    {
    	...
    	sort(arr,arr+n);
    	sort(dep,dep+n);
    	int firstPlat=0,SecPlat=0,count=0;
    	while(firstPlat<n && SecPlat<n)
    	{
    	    if(dep[firstPlat] < arr[SecPlat])  //no need of sec platform
    	    {
    	        firstPlat++;   
    	        SecPlat++;
    	    }
...
/*
Minimum Platforms 
Medium Accuracy: 46.78% Submissions: 38696 Points: 4
